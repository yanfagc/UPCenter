...
<html>
  ...
  <!-- Main content -->
            ...
            <div class="box-header">
              <form class="form-inline legend">
                <div class="form-group">
                  <label class="sr-only" for="realName">快递员姓名</label>
                  <input type="text" class="form-control" id="realName" placeholder="快递员姓名"/>
                </div>
                <div class="form-group">
    ...
    <script type="text/javascript" src="${ctx}/js/postbox/expressman/expressman-list.js<c:if test='${not empty crm}'>?${crm}</c:if>"></script>
  </body>
</html>
