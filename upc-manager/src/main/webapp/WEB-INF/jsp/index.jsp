              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <c:if test="${not empty user.imgurl}">
                    <img src="${ctx}/basic/viewfile/userImage/${user.imgurl}" class="user-image" alt="User Image"/>
                  </c:if>
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-header">
                    ...
                    <c:if test="${not empty user.imgurl}">
                      <img src="${ctx}/basic/viewfile/userImage/${user.imgurl}" class="img-circle" alt="User Image"/>
                    </c:if>
                    <p>
        ...
        <section class="sidebar">
          ...
          <div class="user-panel">
            <div class="pull-left image">
              ...
              <c:if test="${not empty user.imgurl}">
                <img style="min-height:45px;" src="${ctx}/basic/viewfile/userImage/${user.imgurl}" class="img-circle" alt="User Image" />
              </c:if>
            </div>
